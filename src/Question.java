...
public class Question extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup13.add(jRadioButton23);
        jRadioButton23.setText("Yes");

        buttonGroup13.add(jRadioButton24);
        jRadioButton24.setText("No");

        buttonGroup14.add(jRadioButton25);
        jRadioButton25.setText("Yes");

        buttonGroup14.add(jRadioButton26);
        jRadioButton26.setText("No");

        buttonGroup15.add(jRadioButton27);
        jRadioButton27.setText("Yes");

        buttonGroup15.add(jRadioButton28);
        jRadioButton28.setText("No");

        buttonGroup16.add(jRadioButton29);
        jRadioButton29.setText("Yes");

        buttonGroup16.add(jRadioButton30);
        jRadioButton30.setText("No");

        buttonGroup17.add(jRadioButton31);
        jRadioButton31.setText("Yes");

        buttonGroup17.add(jRadioButton32);
        jRadioButton32.setText("No");

        buttonGroup18.add(jRadioButton33);
        jRadioButton33.setText("Yes");

        buttonGroup18.add(jRadioButton34);
        jRadioButton34.setText("No");

        buttonGroup19.add(jRadioButton35);
        jRadioButton35.setText("Yes");

        buttonGroup19.add(jRadioButton36);
